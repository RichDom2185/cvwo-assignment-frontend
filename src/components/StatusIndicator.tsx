import { MdOutlineCloudOff, MdCloudQueue } from "react-icons/md";
import { decompressFromUTF16 } from "lz-string";

const StatusIndicator = () => {
    const currentUserData: string | null = decompressFromUTF16(window.localStorage.getItem("user") ?? '');

    return <div className="transition text-gray-300 select-none flex items-center justify-center gap-x-2 px-3 py-2 rounded-lg"
