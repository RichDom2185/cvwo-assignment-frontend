...
const Tag = (props: Props) => {
    ...
    return (
        <div className={"tag transition flex justify-center rounded-full text-sm font-medium select-none py-1 px-2 border"
            + generateColorClasses(bgColor) + (props.checked ? ' text-gray-500' : '')} onClick={onClick}>
